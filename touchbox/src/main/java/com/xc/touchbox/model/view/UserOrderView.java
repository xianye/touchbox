 ...
 */
public class UserOrderView implements java.io.Serializable {
	...
	private ProductSnapshotView snapshot;
	...
	public ProductSnapshotView getSnapshot() {
		return snapshot;
	}

	public void setSnapshot(ProductSnapshot snapshot) {
		if(snapshot!=null){
			this.snapshot = new ProductSnapshotView();
			BeanUtils.copyProperties(this.snapshot, snapshot);
		}
	}
}
